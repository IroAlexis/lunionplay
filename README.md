...
```bash
$ git clone --recursive https://github.com/IroAlexis/lunion-play.git
$ cd lunion-play
```
...
* `LUNION_PLAY_USE_WINED3D=1`, use OpenGL-based wined3d.
* `LUNION_PLAY_SYNC=<value>`, the possibles `value` list is available below :
...
* `LUNION_PLAY_LOG=value`, convenience method for dumping a useful debug log to your home directory (disabled by default) :
